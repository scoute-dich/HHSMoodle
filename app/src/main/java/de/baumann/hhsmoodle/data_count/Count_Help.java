...
public class Count_Help extends OnboarderActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        OnboarderPage onboarderPage1 = new OnboarderPage(getString(R.string.count_help1), getString(R.string.count_help_text1), R.drawable.help_count_1);
        OnboarderPage onboarderPage2 = new OnboarderPage(getString(R.string.count_help2), getString(R.string.count_help_text2), R.drawable.help_count_2);
