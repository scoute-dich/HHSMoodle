...
public class Courses_Help extends OnboarderActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        OnboarderPage onboarderPage1 = new OnboarderPage(getString(R.string.course_help1), getString(R.string.course_help_text1), R.drawable.help_course_2);
        OnboarderPage onboarderPage2 = new OnboarderPage(getString(R.string.course_help2), getString(R.string.course_help_text2), R.drawable.help_course_1);
