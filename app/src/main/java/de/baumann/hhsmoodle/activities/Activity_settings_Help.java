...
public class Activity_settings_Help extends OnboarderActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        OnboarderPage onboarderPage1 = new OnboarderPage(getString(R.string.settings_help1), getString(R.string.settings_help_text1), R.drawable.help_settings_1);
        OnboarderPage onboarderPage2 = new OnboarderPage(getString(R.string.settings_help2), getString(R.string.settings_help_text2), R.drawable.screenshot_7);
