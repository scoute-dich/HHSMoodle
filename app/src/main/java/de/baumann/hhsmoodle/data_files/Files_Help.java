...
public class Files_Help extends OnboarderActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        OnboarderPage onboarderPage1 = new OnboarderPage(getString(R.string.files_help1), getString(R.string.files_help_text1), R.drawable.files_help_1);
        OnboarderPage onboarderPage2 = new OnboarderPage(getString(R.string.files_help2), getString(R.string.files_help_text2), R.drawable.files_help_2);
