...
public class Random_Help extends OnboarderActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        OnboarderPage onboarderPage1 = new OnboarderPage(getString(R.string.random_help1), getString(R.string.random_help_text1), R.drawable.help_rand_1);
        OnboarderPage onboarderPage2 = new OnboarderPage(getString(R.string.random_help2), getString(R.string.random_help_text2), R.drawable.help_rand_2);
