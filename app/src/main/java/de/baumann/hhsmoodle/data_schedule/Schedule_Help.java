...
public class Schedule_Help extends OnboarderActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        OnboarderPage onboarderPage1 = new OnboarderPage(getString(R.string.schedule_help1), getString(R.string.schedule_help_text1), R.drawable.help_schedule_2);
        OnboarderPage onboarderPage2 = new OnboarderPage(getString(R.string.schedule_help2), getString(R.string.schedule_help_text2), R.drawable.help_schedule_1);
