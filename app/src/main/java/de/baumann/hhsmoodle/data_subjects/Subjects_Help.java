...
public class Subjects_Help extends OnboarderActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        OnboarderPage onboarderPage1 = new OnboarderPage(getString(R.string.subject_help1), getString(R.string.subject_help_text1), R.drawable.help_subject_1);
        OnboarderPage onboarderPage2 = new OnboarderPage(getString(R.string.subject_help2), getString(R.string.subject_help_text2), R.drawable.help_subject_2);
